...
export default function Select_Criterio() {
  return (
    <div className="flex flex-col ">
        <div>
            <span className="text-gray-600 text-[14px]">Criterio de busqueda<i className="text-red-600 font-bold">*</i></span>
        </div>
        <div className="flex justify-between items-center border-1 border-gray-300  rounded-xs p-1.5 w-50">
            <span className="text-[14px] text-gray-500">Seleccionar tipo consulta</span>
